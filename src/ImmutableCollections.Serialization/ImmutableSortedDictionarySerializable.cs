...
{
    public sealed class ImmutableSortedDictionarySerializable<TKey, TValue> : IDictionary<TKey, TValue>, ICollectionSerializable<ImmutableSortedDictionary<TKey, TValue>, KeyValuePair<TKey, TValue>>
    {
        private readonly ImmutableSortedDictionary<TKey, TValue>.Builder _builder = ImmutableSortedDictionary.CreateBuilder<TKey, TValue>();

        private ImmutableSortedDictionary<TKey, TValue> _value;

        public ImmutableSortedDictionary<TKey, TValue> Value
        {
